...
public class ProcessamentoMidia {
	...
	public void salvarFoto() {
		...
		try {
			...
			for (Foto foto : fotos) {
				linha = foto.getCaminhoArquivo() + ";" + foto.getTitulo() + ";" + foto.getDescricao() + ";"
						+ foto.getFotografo() + ";" + foto.getPessoas() + ";" + foto.getLocal() + ";" + foto.getData()
						+ ";";
				bc.write(linha);
				bc.newLine();
			}
	...
	public void salvarMusica() {
		...
		try {
			...
			for (Musica m : musicas) {
				linha = m.getCaminhoArquivo() + ";" + m.getTitulo() + ";" + m.getDescricao() + ";" + m.getGenero() + ";"
						+ m.getIdioma() + ";" + m.getAutores() + ";" + m.getInterpretes() + ";" + m.getDuracao() + ";"
						+ m.getAno() + ";";
				bc.write(linha);
				bc.newLine();
			}
	...
	public void salvarFilme() {
		...
		try {
			...
			BufferedWriter bc = new BufferedWriter(fc);
			for (Filme f : filmes) {
				linha = f.getCaminhoArquivo() + ";" + f.getTitulo() + ";" + f.getDescricao() + ";" + f.getGenero() + ";"
						+ f.getIdioma() + ";" + f.getDiretor() + ";" + f.getAtoresPrincipais() + ";" + f.getDuracao()
						+ ";" + f.getAno() + ";";
				bc.write(linha);
				bc.newLine();
			}
